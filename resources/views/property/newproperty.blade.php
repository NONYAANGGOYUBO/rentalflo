 ...
 <form action="{{route('storeproperty')}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="flex">
        <div>
            ...
            <input type="text" name="title" placeholder="Enter property title/name"  value="{{old('title')}}"  class="border border-gray-200 w-[650px] ml-9 mt-4">
        ...
        <div>
            ...
            <input type="text" name="address1" placeholder="Enter address line-1" value="{{old('address1')}}"  class="border border-gray-200 w-[650px] ml-10 mt-4">
    ...
    <div class="flex mt-5">
        <div>
            ...
            <input type="text" name="address2" placeholder="Enter address line 2" value="{{old('address2')}}"   class="border border-gray-200 w-[650px] ml-9 mt-4">
            <div class="mt-1 ml-10">
                @error('address2')
                <span class="text-red-500">{{$message}}</span>
                @enderror
    ...
    <div class="flex mt-5">
        <div>
            ...
            <input type="text" name="pincode" placeholder="Enter pincode" value="{{old('pincode')}}"   class="border border-gray-200 w-[650px] ml-9 mt-4">
            <div class="mt-1 ml-10">
                @error('pincode')
                <span class="text-red-500">{{$message}}</span>
                 @enderror
        ...
        <div>
            ...
            <input type="text" name="rent" placeholder="Enter rent amount"  value="{{old('rent')}}"  class="border border-gray-200 w-[650px] ml-10 mt-4">
            <div class="mt-1 ml-10">
                @error('rent')
                <span class="text-red-500">{{$message}}</span>
                 @enderror
